                ...
                <form class="grid grid-cols-12 gap-4 mt-0" action="{{ route('notices.store') }}" method="POST">
                    ...
                    <div class="md:col-span-6 col-span-12">
                        ...
                        <div class="relative">
                            ...
                            <select class="select2 w-full" name="departments[]" multiple>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    @if (session('calendar') == 'BS')
                                        <input
                                            class="nepali-datepicker form-control flatpickr-input active @error('date') ti-form-input !border-danger focus:border-danger focus:ring-danger @enderror"
                                            id="" type="text" name="date" placeholder="Choose date"
                                            readonly="readonly"
                                            value="{{ old('date', App\Services\DateService::ADToBS(date('Y-m-d'))) }}">
                                    @else
                                        <input
                    ...
                    <div class="col-span-12">
                        <button class="ti-btn ti-btn-primary-full submitbtn" type="submit">Submit <span
                               style="display: none" class="ti-spinner text-white !w-[1rem] !h-[1rem]" role="status"
