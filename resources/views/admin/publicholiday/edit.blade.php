                            ...
                            <div class="relative">
                                @if (session('calendar') == 'BS')
                                    <input
                                        ...
                                        readonly="readonly"
                                        value="{{ old('start_date', App\Services\DateService::ADToBS($publicholiday->start_date)) }}">
                                @else
                                    <input
                            ...
                            <div class="relative">
                                @if (session('calendar') == 'BS')
                                    <input
                                        ...
                                        readonly="readonly"
                                        value="{{ old('end_date', App\Services\DateService::ADToBS($publicholiday->end_date)) }}">
                                @else
                                    <input
