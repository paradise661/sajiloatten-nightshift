                            ...
                            <div class="flex items-center space-x-4">
                                <div class="form-check flex form-check-md items-center">
                                    <input class="form-check-input" id="male" type="radio"
                                        {{ $leavetype->gender == 'Male' ? 'checked' : '' }} value="Male" name="gender">
                    ...
                    <div class="md:col-span-6 col-span-12">
                        ...
                        <div class="form-check form-check-md flex item-center">
                            <input class="form-check-input" id="requiresAdvanceCheckbox" type="checkbox" value="1"
                                ...
                                {{ old('requires_advance_application', $leavetype->requires_advance_application) ? 'checked' : '' }}>
                        </div>
                    </div>

                    <div class="md:col-span-6 col-span-12" id="minDaysContainer" style="display: none;">
                        <label class="form-label mt-2">Minimum Days Before Application <span
                        ...
                        <div class="relative">
                            <input
                                ...
                                value="{{ old('min_days_before', $leavetype->min_days_before) }}" min="1">
